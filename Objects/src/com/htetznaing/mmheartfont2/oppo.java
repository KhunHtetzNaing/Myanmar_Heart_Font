...
public class oppo extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmheartfont2", "com.htetznaing.mmheartfont2.oppo");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmheartfont2", "com.htetznaing.mmheartfont2.oppo");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmheartfont2.oppo", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"MyanmarHeartFont(iFont).apk",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"MyanmarHeartFont(iFont).apk");
 //BA.debugLineNum = 112;BA.debugLine="Msgbox(\"1. Install Fone App\" & CRLF & \"2. After I";
...
_i.Initialize(_i.ACTION_VIEW,"file:///"+anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/MyanmarHeartFont(iFont).apk");
 //BA.debugLineNum = 115;BA.debugLine="i.SetType(\"application/vnd.android.package-archiv";
...
_i.Initialize("","");
 //BA.debugLineNum = 126;BA.debugLine="i.SetComponent(\"com.android.settings/.flipfont.F";
