...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmheartfont2", "com.htetznaing.mmheartfont2.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmheartfont2", "com.htetznaing.mmheartfont2.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmheartfont2.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._lb.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 49;BA.debugLine="Activity.AddView(lb,0%x,(imv.Height+imv.Top),100%x";
...
mostCurrent._atx._initialize(mostCurrent.activityBA,"atx",main.getObject(),(int) (200));
 //BA.debugLineNum = 53;BA.debugLine="atx.Run( \" ♡ ငါနင့္ကိုခ်စ္တယ္ ♡\" &CRLF& \"I Love Yo";
...
mostCurrent._b1.setTextSize((float) (17));
 //BA.debugLineNum = 64;BA.debugLine="Activity.AddView(b1,20%x,(lb.Top+lb.Height)+1%y,60";
...
mostCurrent._b2.setTextSize((float) (17));
 //BA.debugLineNum = 72;BA.debugLine="Activity.AddView(b2,20%x,(b1.Top+b1.Height)+2%y,60";
...
mostCurrent._b3.setTextSize((float) (17));
 //BA.debugLineNum = 80;BA.debugLine="Activity.AddView(b3,20%x,(b2.Top+b2.Height)+2%y,60";
...
mostCurrent._b4.setTextSize((float) (17));
 //BA.debugLineNum = 88;BA.debugLine="Activity.AddView(b4,20%x,(b3.Top+b3.Height)+2%y,60";
...
mostCurrent._tlb.Initialize(mostCurrent.activityBA,"tlb");
 //BA.debugLineNum = 98;BA.debugLine="tlb.Text = \"Myanmar Heart Font\"";
mostCurrent._tlb.setText((Object)("Myanmar Heart Font"));
 //BA.debugLineNum = 99;BA.debugLine="tlb.Color = Colors.RGB(33,150,243)";
...
mostCurrent._activity.AddView((android.view.View)(mostCurrent._share.getObject()),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (12.5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)));
 //BA.debugLineNum = 130;BA.debugLine="Banner.Initialize(\"Banner\",\"ca-app-pub-4173348573";
mostCurrent._banner.Initialize(mostCurrent.activityBA,"Banner","ca-app-pub-4173348573252986/1553645756");
 //BA.debugLineNum = 131;BA.debugLine="Banner.LoadAd";
mostCurrent._banner.LoadAd();
 //BA.debugLineNum = 132;BA.debugLine="Activity.AddView(Banner,0%x,100%y - 50dip,100%x,5";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._banner.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA),(int) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)));
 //BA.debugLineNum = 134;BA.debugLine="Interstitial.Initialize(\"Interstitial\",\"ca-app-pu";
...
mostCurrent._interstitial.LoadAd();
 //BA.debugLineNum = 137;BA.debugLine="ad1.Initialize(\"ad1\",100)";
...
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 139;BA.debugLine="ad2.Initialize(\"ad2\",60000)";
_ad2.Initialize(processBA,"ad2",(long) (60000));
 //BA.debugLineNum = 140;BA.debugLine="ad2.Enabled = True";
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 ...
 //BA.debugLineNum = 201;BA.debugLine="ml.rmrf(File.DirRootExternal & \"/MyanmarAndroidAp";
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 204;BA.debugLine="Answ = Msgbox2(\"If you want to get new updates o";
_answ = anywheresoftware.b4a.keywords.Common.Msgbox2("If you want to get new updates on  Facebook? Please Like "+anywheresoftware.b4a.keywords.Common.CRLF+"Myanmar Android Apps Page!","Attention!","Yes","","No",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"fb.png").getObject()),mostCurrent.activityBA);
 //BA.debugLineNum = 205;BA.debugLine="If Answ = DialogResponse.NEGATIVE Then";
if (_answ==anywheresoftware.b4a.keywords.Common.DialogResponse.NEGATIVE) { 
 //BA.debugLineNum = 207;BA.debugLine="If ph.SdkVersion > 19 Then";
if (mostCurrent._ph.getSdkVersion()>19) { 
 //BA.debugLineNum = 208;BA.debugLine="ad1.Enabled = True";
...
if (true) return anywheresoftware.b4a.keywords.Common.False;
 ...
 //BA.debugLineNum = 213;BA.debugLine="If Answ = DialogResponse.POSITIVE Then";
if (_answ==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 214;BA.debugLine="If ph.SdkVersion > 19 Then";
if (mostCurrent._ph.getSdkVersion()>19) { 
 //BA.debugLineNum = 215;BA.debugLine="ad1.Enabled = True";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
...
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_facebook.getObject()));
			...
			processBA.setLastException(e21); //BA.debugLineNum = 226;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 227;BA.debugLine="i.Initialize(i.ACTION_VIEW, \"https://m.facebook";
...
public static String  _ad1_tick() throws Exception{
 //BA.debugLineNum = 182;BA.debugLine="Sub ad1_Tick";
 //BA.debugLineNum = 183;BA.debugLine="If Interstitial.Ready Then Interstitial.Show";
if (mostCurrent._interstitial.getReady()) { 
mostCurrent._interstitial.Show();};
 //BA.debugLineNum = 184;BA.debugLine="ad1.Enabled = False";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 185;BA.debugLine="End Sub";
return "";
}
public static String  _ad2_tick() throws Exception{
 //BA.debugLineNum = 191;BA.debugLine="Sub ad2_Tick";
...
public static String  _b1_click() throws Exception{
 //BA.debugLineNum = 161;BA.debugLine="Sub b1_Click";
 //BA.debugLineNum = 162;BA.debugLine="StartActivity(Main2)";
...
public static String  _b2_click() throws Exception{
 //BA.debugLineNum = 165;BA.debugLine="Sub b2_Click";
 //BA.debugLineNum = 166;BA.debugLine="StartActivity(Tutorial)";
...
public static String  _b3_click() throws Exception{
 //BA.debugLineNum = 169;BA.debugLine="Sub b3_Click";
 //BA.debugLineNum = 170;BA.debugLine="StartActivity(About)";
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _p = null;
 //BA.debugLineNum = 173;BA.debugLine="Sub b4_Click";
 //BA.debugLineNum = 174;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 175;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.htetznain";
...
anywheresoftware.b4a.objects.IntentWrapper _facebook = null;
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 143;BA.debugLine="Sub ft_Click";
...
mostCurrent._b4 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 23;BA.debugLine="Dim mm As Typeface : mm = mm.LoadFromAssets(\"Myanm";
...
public static String  _interstitial_adclosed() throws Exception{
 //BA.debugLineNum = 187;BA.debugLine="Sub Interstitial_AdClosed";
...
public static String  _menu_click() throws Exception{
 //BA.debugLineNum = 271;BA.debugLine="Sub menu_Click";
 //BA.debugLineNum = 272;BA.debugLine="If sm.isVisible Then sm.Hide Else sm.Show";
...
anywheresoftware.b4a.objects.IntentWrapper _shareit = null;
 //BA.debugLineNum = 275;BA.debugLine="Sub share_Click";
 //BA.debugLineNum = 276;BA.debugLine="Dim ShareIt As Intent";
_shareit = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 277;BA.debugLine="copy.clrText";
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 278;BA.debugLine="copy.setText(\"#Myanmar_Heart_Font App! Beautiful";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Heart_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.htetznaing.com/myanmar-heart-font/");
 //BA.debugLineNum = 279;BA.debugLine="ShareIt.Initialize (ShareIt.ACTION_SEND,\"\")";
_shareit.Initialize(_shareit.ACTION_SEND,"");
 //BA.debugLineNum = 280;BA.debugLine="ShareIt.SetType (\"text/plain\")";
_shareit.SetType("text/plain");
 //BA.debugLineNum = 281;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",cop";
_shareit.PutExtra("android.intent.extra.TEXT",(Object)(mostCurrent._copy.getText(mostCurrent.activityBA)));
 //BA.debugLineNum = 282;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.SUBJECT\",";
_shareit.PutExtra("android.intent.extra.SUBJECT",(Object)("Get Free!!"));
 //BA.debugLineNum = 283;BA.debugLine="ShareIt.WrapAsIntentChooser(\"Share App Via...\")";
_shareit.WrapAsIntentChooser("Share App Via...");
 //BA.debugLineNum = 284;BA.debugLine="StartActivity (ShareIt)";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 256;BA.debugLine="copy.setText(\"#Myanmar_Heart_Font App! Beautifu";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Heart_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.htetznaing.com/myanmar-heart-font/");
...
_shareit.SetType("text/plain");
 //BA.debugLineNum = 259;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",c";
_shareit.PutExtra("android.intent.extra.TEXT",(Object)(mostCurrent._copy.getText(mostCurrent.activityBA)));
...
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_shareit.getObject()));
 break; }
case 7: {
 //BA.debugLineNum = 264;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 265;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.htetzna";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_p.OpenBrowser("http://www.htetznaing.com")));
 break; }
case 8: {
 //BA.debugLineNum = 267;BA.debugLine="StartActivity(About)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._about.getObject()));
 break; }
}
;
