...
_lblname.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 46;BA.debugLine="lblName.Text = \"PaOh Music App\"";
_lblname.setText((Object)("PaOh Music App"));
...
mostCurrent._lstone.AddSingleLine2("App Name : Myanmar Heart Font",(Object)(6));
 //BA.debugLineNum = 62;BA.debugLine="lstOne.AddSingleLine2(\"Version : 1.0\",7)";
mostCurrent._lstone.AddSingleLine2("Version : 1.0",(Object)(7));
 //BA.debugLineNum = 63;BA.debugLine="lstOne.AddSingleLine2 (\"Developed By : Khun Htetz";
mostCurrent._lstone.AddSingleLine2("Developed By : Khun Htetz Naing    ",(Object)(1));
 //BA.debugLineNum = 64;BA.debugLine="lstOne.AddSingleLine2 (\"Website : www.HtetzNaing.";
mostCurrent._lstone.AddSingleLine2("Website : www.HtetzNaing.com  ",(Object)(4));
 //BA.debugLineNum = 65;BA.debugLine="lstOne.AddSingleLine2 (\"Facebook : www.fb.com/MmF";
mostCurrent._lstone.AddSingleLine2("Facebook : www.fb.com/MmFreeAndroidApps   ",(Object)(5));
 //BA.debugLineNum = 66;BA.debugLine="Activity.AddView ( lstOne, 30dip , 170dip , 100%x";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._lstone.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (170)),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (200)));
 //BA.debugLineNum = 68;BA.debugLine="Dim lblCredit As Label";
_lblcredit = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 69;BA.debugLine="lblCredit.Initialize (\"lblCredit\")";
_lblcredit.Initialize(mostCurrent.activityBA,"lblCredit");
 //BA.debugLineNum = 70;BA.debugLine="lblCredit.TextColor = Colors.RGB (74,20,140)";
_lblcredit.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (74),(int) (20),(int) (140)));
 //BA.debugLineNum = 71;BA.debugLine="lblCredit.TextSize = 13";
_lblcredit.setTextSize((float) (13));
 //BA.debugLineNum = 72;BA.debugLine="lblCredit.Gravity = Gravity.CENTER";
_lblcredit.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 73;BA.debugLine="lblCredit.Text = \"If You have any Problem You can";
_lblcredit.setText((Object)("If You have any Problem You can contact Me."));
 //BA.debugLineNum = 74;BA.debugLine="Activity.AddView (lblCredit, 10dip,(lstOne.Top+ls";
mostCurrent._activity.AddView((android.view.View)(_lblcredit.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) ((mostCurrent._lstone.getTop()+mostCurrent._lstone.getHeight())+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (3),mostCurrent.activityBA)),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)));
 //BA.debugLineNum = 75;BA.debugLine="lblCredit.Height = su.MeasureMultilineTextHeight";
...
mostCurrent._tlb.Initialize(mostCurrent.activityBA,"tlb");
 //BA.debugLineNum = 78;BA.debugLine="tlb.Text = \"Myanmar Heart Font\"";
...
mostCurrent._sm._additem("Other [#Root]",anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"other.png"),(Object)(6));
 //BA.debugLineNum = 94;BA.debugLine="sm.AddItem(\"About\",LoadBitmap(File.DirAssets,\"abo";
...
mostCurrent._activity.AddView((android.view.View)(mostCurrent._menu.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (12.5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)));
 //BA.debugLineNum = 105;BA.debugLine="Banner.Initialize(\"Banner\",\"ca-app-pub-4173348573";
mostCurrent._banner.Initialize(mostCurrent.activityBA,"Banner","ca-app-pub-4173348573252986/1553645756");
 //BA.debugLineNum = 106;BA.debugLine="Banner.LoadAd";
mostCurrent._banner.LoadAd();
 //BA.debugLineNum = 107;BA.debugLine="Activity.AddView(Banner,0%x,100%y - 50dip,100%x,5";
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 122;BA.debugLine="Sub imv_Click";
 //BA.debugLineNum = 123;BA.debugLine="Try";
try { //BA.debugLineNum = 125;BA.debugLine="Dim Facebook As Intent";
_facebook = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 127;BA.debugLine="Facebook.Initialize(Facebook.ACTION_VIEW, \"fb://";
...
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_facebook.getObject()));
			...
			processBA.setLastException(e6); //BA.debugLineNum = 132;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 133;BA.debugLine="i.Initialize(i.ACTION_VIEW, \"https://m.facebook.";
...
anywheresoftware.b4a.objects.IntentWrapper _facebook = null;
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 144;BA.debugLine="Sub lblCredit_Click";
...
public static String  _lbname_click() throws Exception{
 //BA.debugLineNum = 140;BA.debugLine="Sub lbname_Click";
 //BA.debugLineNum = 141;BA.debugLine="StartActivity(p.OpenBrowser(\"https://play.google.";
...
anywheresoftware.b4a.objects.IntentWrapper _facebook = null;
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 169;BA.debugLine="Sub lstOnes_ItemClick (Position As Int, Value As O";
 //BA.debugLineNum = 170;BA.debugLine="Select Value";
switch (BA.switchObjectToInt(_value,(Object)(1),(Object)(4),(Object)(5),(Object)(6))) {
case 0: {
 //BA.debugLineNum = 172;BA.debugLine="Try";
try { //BA.debugLineNum = 174;BA.debugLine="Dim Facebook As Intent";
_facebook = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 176;BA.debugLine="Facebook.Initialize(Facebook.ACTION_VIEW, \"fb:";
_facebook.Initialize(_facebook.ACTION_VIEW,"fb://profile/100006126339714");
 //BA.debugLineNum = 177;BA.debugLine="StartActivity(Facebook)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_facebook.getObject()));
 } 
       catch (Exception e8) {
			processBA.setLastException(e8); //BA.debugLineNum = 181;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 182;BA.debugLine="i.Initialize(i.ACTION_VIEW, \"https://m.faceboo";
_i.Initialize(_i.ACTION_VIEW,"https://m.facebook.com/MgHtetzNaing");
 //BA.debugLineNum = 184;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 };
 break; }
case 1: {
 //BA.debugLineNum = 189;BA.debugLine="StartActivity(p.OpenBrowser (\"http://www.htetzn";
...
try { //BA.debugLineNum = 194;BA.debugLine="Dim Facebook As Intent";
_facebook = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 196;BA.debugLine="Facebook.Initialize(Facebook.ACTION_VIEW, \"fb:";
_facebook.Initialize(_facebook.ACTION_VIEW,"fb://page/627699334104477");
 //BA.debugLineNum = 197;BA.debugLine="StartActivity(Facebook)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_facebook.getObject()));
 } 
       catch (Exception e20) {
			processBA.setLastException(e20); //BA.debugLineNum = 201;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 202;BA.debugLine="i.Initialize(i.ACTION_VIEW, \"https://m.faceboo";
_i.Initialize(_i.ACTION_VIEW,"https://m.facebook.com/MmFreeAndroidApps");
...
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 ...
 break; }
case 3: {
 //BA.debugLineNum = 208;BA.debugLine="StartActivity(p.OpenBrowser(\"https://play.googl";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._p.OpenBrowser("https://play.google.com/store/apps/details?id=com.htetznaing.mmheartfont")));
 break; }
}
;
...
public static String  _menu_click() throws Exception{
 //BA.debugLineNum = 240;BA.debugLine="Sub menu_Click";
 //BA.debugLineNum = 241;BA.debugLine="If sm.isVisible Then";
if (mostCurrent._sm._isvisible()) { 
 //BA.debugLineNum = 242;BA.debugLine="sm.Hide";
mostCurrent._sm._hide();
 }else {
 //BA.debugLineNum = 244;BA.debugLine="sm.Show";
...
public static String  _slidemenu_click(Object _item) throws Exception{
 //BA.debugLineNum = 212;BA.debugLine="Sub SlideMenu_Click(Item As Object)";
 //BA.debugLineNum = 213;BA.debugLine="sm.Hide";
mostCurrent._sm._hide();
 //BA.debugLineNum = 238;BA.debugLine="End Sub";
return "";
}
public static String  _t_tick() throws Exception{
 //BA.debugLineNum = 110;BA.debugLine="Sub t_Tick";
