...
Sub b1_Click
	...
	If File.Exists(File.DirRootExternal & "/HWThemes","MyanmarHeartFont.hwt") = True Then File.Delete(File.DirRootExternal,"MyanmarHeartFont.hwt")
	File.Copy(File.DirAssets,"MyanmarHeartFont.hwt",File.DirRootExternal & "/HWThemes","MyanmarHeartFont.hwt")
