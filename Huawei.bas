...
Sub b1_Click
	...
	If File.Exists(File.DirRootExternal & "/HWThemes","Heart.hwt") = True Then File.Delete(File.DirRootExternal,"Heart.hwt")
	File.Copy(File.DirAssets,"Heart.hwt",File.DirRootExternal & "/HWThemes","Heart.hwt")
