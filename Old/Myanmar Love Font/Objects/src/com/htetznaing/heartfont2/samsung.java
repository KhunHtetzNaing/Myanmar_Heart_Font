...
public class samsung extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.heartfont2", "com.htetznaing.heartfont2.samsung");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.heartfont2", "com.htetznaing.heartfont2.samsung");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.heartfont2.samsung", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._activity.setTitle((Object)("Samsung"));
...
mostCurrent._interstitial.LoadAd();
 //BA.debugLineNum = 36;BA.debugLine="ad1.Initialize(\"ad1\",100)";
_ad1.Initialize(processBA,"ad1",(long) (100));
 //BA.debugLineNum = 37;BA.debugLine="ad1.Enabled = False";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 38;BA.debugLine="ad2.Initialize(\"ad2\",30000)";
_ad2.Initialize(processBA,"ad2",(long) (30000));
 //BA.debugLineNum = 39;BA.debugLine="ad2.Enabled = True";
...
mostCurrent._activity.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 42;BA.debugLine="ph.SetScreenOrientation(1)";
...
mostCurrent._lb.Initialize(mostCurrent.activityBA,"lb");
 //BA.debugLineNum = 45;BA.debugLine="lb.Text = \"1. ပထမဦးစြာ Install ကိုနွိပ္ျပီး \" &CR";
mostCurrent._lb.setText((Object)("1. ပထမဦးစြာ Install ကိုနွိပ္ျပီး "+anywheresoftware.b4a.keywords.Common.CRLF+"Myanmar Love(ifont) ကို Install လုပ္လိုက္ပါ။"+anywheresoftware.b4a.keywords.Common.CRLF+anywheresoftware.b4a.keywords.Common.CRLF+"2. Install လုပ္ျပီးပါက Done ကိုနွိပ္ပါ။"+anywheresoftware.b4a.keywords.Common.CRLF+"ၿပီးလၽွင္ေအာက္က Change Font ကိုနွိပ္ပါ။"+anywheresoftware.b4a.keywords.Common.CRLF+"Font သို့ Font Style ထဲကိုဆက္ဝင္ျပီး"+anywheresoftware.b4a.keywords.Common.CRLF+"Myanmar Love Font(ifont) ကိုေရြးေပးလိုက္ပါ။"+anywheresoftware.b4a.keywords.Common.CRLF+anywheresoftware.b4a.keywords.Common.CRLF+"Android 5.0 အထက္တခ်ို့ဖုန္းေတြမွာ Font not supported လို့ျပလာခဲ့လၽွင္ Tutorial ကိုနွိပ္ျပီးေျဖရွင္းနည္းကိုသြားျကည့္လိုက္ပါ။"));
 //BA.debugLineNum = 46;BA.debugLine="Activity.AddView(lb,2%x,2%y,90%x,45%y)";
...
mostCurrent._lb.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 48;BA.debugLine="lb.Typeface = mm";
mostCurrent._lb.setTypeface((android.graphics.Typeface)(mostCurrent._mm.getObject()));
 //BA.debugLineNum = 50;BA.debugLine="bg.Initialize(Colors.Black,15)";
...
mostCurrent._b1.Initialize(mostCurrent.activityBA,"b1");
 //BA.debugLineNum = 52;BA.debugLine="b1.Text = \"Install\"";
mostCurrent._b1.setText((Object)("Install"));
 //BA.debugLineNum = 53;BA.debugLine="b1.Background = bg";
...
mostCurrent._b2.Initialize(mostCurrent.activityBA,"b2");
 //BA.debugLineNum = 56;BA.debugLine="b2.Text = \"Change Font\"";
mostCurrent._b2.setText((Object)("Change Font"));
 //BA.debugLineNum = 57;BA.debugLine="b2.Background = bg";
...
mostCurrent._b3.setText((Object)("Tutorial"));
 //BA.debugLineNum = 61;BA.debugLine="b3.Background = bg";
mostCurrent._b3.setBackground((android.graphics.drawable.Drawable)(mostCurrent._bg.getObject()));
 //BA.debugLineNum = 63;BA.debugLine="Activity.AddView(b1,20%x,(lb.Top+lb.Height),60%x,5";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._b1.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),(int) ((mostCurrent._lb.getTop()+mostCurrent._lb.getHeight())),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (60),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)));
 //BA.debugLineNum = 64;BA.debugLine="Activity.AddView(b2,20%x,(b1.Top+b1.Height)+2%y,60";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._b2.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),(int) ((mostCurrent._b1.getTop()+mostCurrent._b1.getHeight())+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (60),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)));
 //BA.debugLineNum = 65;BA.debugLine="Activity.AddView(b3,20%x,(b2.Top+b2.Height)+2%y,60";
...
public static String  _ad1_tick() throws Exception{
 //BA.debugLineNum = 100;BA.debugLine="Sub ad1_Tick";
 //BA.debugLineNum = 101;BA.debugLine="If Interstitial.Ready Then Interstitial.Show Else";
if (mostCurrent._interstitial.getReady()) { 
mostCurrent._interstitial.Show();}
else {
mostCurrent._interstitial.LoadAd();};
 //BA.debugLineNum = 102;BA.debugLine="ad1.Enabled = False";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 103;BA.debugLine="End Sub";
return "";
}
public static String  _ad2_tick() throws Exception{
 //BA.debugLineNum = 105;BA.debugLine="Sub ad2_Tick";
 //BA.debugLineNum = 106;BA.debugLine="If Interstitial.Ready Then Interstitial.Show Else";
if (mostCurrent._interstitial.getReady()) { 
mostCurrent._interstitial.Show();}
else {
mostCurrent._interstitial.LoadAd();};
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 ...
 //BA.debugLineNum = 69;BA.debugLine="If ph.SdkVersion > 19 Then";
if (mostCurrent._ph.getSdkVersion()>19) { 
 //BA.debugLineNum = 70;BA.debugLine="ad1.Enabled = True";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 72;BA.debugLine="Msgbox(\"1. Install Font App\" & CRLF & \"2. After C";
anywheresoftware.b4a.keywords.Common.Msgbox("1. Install Font App"+anywheresoftware.b4a.keywords.Common.CRLF+"2. After Click Change Font and Choose your Font!","Attention!",mostCurrent.activityBA);
 //BA.debugLineNum = 73;BA.debugLine="File.Copy(File.DirAssets,\"MyFont.zip\",File.DirRoo";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"MyFont.zip",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"MyFont.zip");
 //BA.debugLineNum = 74;BA.debugLine="zip.ABUnzip(sd & \"MyFont.zip\",sd & \"MyFont\")";
mostCurrent._zip.ABUnzip(mostCurrent._sd+"MyFont.zip",mostCurrent._sd+"MyFont");
 //BA.debugLineNum = 75;BA.debugLine="File.Delete(File.DirRootExternal,\"MyFont.zip\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"MyFont.zip");
 //BA.debugLineNum = 76;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 77;BA.debugLine="i.Initialize(i.ACTION_VIEW,\"file:///\"&File.Dir";
_i.Initialize(_i.ACTION_VIEW,"file:///"+anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/MyFont/MyFont.apk");
 //BA.debugLineNum = 78;BA.debugLine="i.SetType(\"application/vnd.android.package-archiv";
_i.SetType("application/vnd.android.package-archive");
 //BA.debugLineNum = 79;BA.debugLine="StartActivity(i)";
...
anywheresoftware.b4a.objects.IntentWrapper _abc = null;
 //BA.debugLineNum = 82;BA.debugLine="Sub b2_Click";
 //BA.debugLineNum = 83;BA.debugLine="If ph.SdkVersion > 19 Then";
if (mostCurrent._ph.getSdkVersion()>19) { 
 //BA.debugLineNum = 84;BA.debugLine="ad1.Enabled = True";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 86;BA.debugLine="ToastMessageShow(\"1. Click Font Style Or Font >";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("1. Click Font Style Or Font > "+anywheresoftware.b4a.keywords.Common.CRLF+"2. Choose Myanmar Love Font(iFont)",anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 87;BA.debugLine="Dim abc As Intent";
_abc = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 88;BA.debugLine="abc.Initialize(\"android.settings.DISPLAY_SETTINGS";
_abc.Initialize("android.settings.DISPLAY_SETTINGS","");
 //BA.debugLineNum = 89;BA.debugLine="StartActivity(abc)";
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _i = null;
 //BA.debugLineNum = 92;BA.debugLine="Sub b3_Click";
 //BA.debugLineNum = 93;BA.debugLine="If ph.SdkVersion > 19 Then";
if (mostCurrent._ph.getSdkVersion()>19) { 
 //BA.debugLineNum = 94;BA.debugLine="ad1.Enabled = True";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 96;BA.debugLine="Dim i As PhoneIntents";
_i = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 97;BA.debugLine="StartActivity(i.OpenBrowser(\"http://www.htetznain";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.OpenBrowser("http://www.htetznaing.com/fix-font-Not-supported-error/")));
...
mostCurrent._zip = new com.AB.ABZipUnzip.ABZipUnzip();
 //BA.debugLineNum = 17;BA.debugLine="Dim sd As String = File.DirRootExternal & \"/\"";
mostCurrent._sd = anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/";
 //BA.debugLineNum = 18;BA.debugLine="Dim lb As Label";
mostCurrent._lb = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 19;BA.debugLine="Dim bg As ColorDrawable";
mostCurrent._bg = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
 //BA.debugLineNum = 20;BA.debugLine="Dim mm As Typeface : mm = mm.LoadFromAssets(\"MyFon";
