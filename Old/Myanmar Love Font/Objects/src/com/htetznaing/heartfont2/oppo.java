...
public class oppo extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.heartfont2", "com.htetznaing.heartfont2.oppo");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.heartfont2", "com.htetznaing.heartfont2.oppo");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.heartfont2.oppo", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._activity.setTitle((Object)("Oppo"));
...
mostCurrent._lb.setText((Object)("1. ပထမဦးစြာ Install ကိုနွိပ္ျပီး "+anywheresoftware.b4a.keywords.Common.CRLF+"Myanmar Love(ifont) ကို Install လုပ္လိုက္ပါ။"+anywheresoftware.b4a.keywords.Common.CRLF+anywheresoftware.b4a.keywords.Common.CRLF+"2. Install လုပ္ျပီးပါက Done ကိုနွိပ္ပါ။"+anywheresoftware.b4a.keywords.Common.CRLF+"ၿပီးလၽွင္ေအာက္က Change Font ကိုနွိပ္ပါ။"+anywheresoftware.b4a.keywords.Common.CRLF+"Font သို့ Font Style ထဲကိုဆက္ဝင္ျပီး"+anywheresoftware.b4a.keywords.Common.CRLF+"Myanmar Love Font(ifont) ကိုေရြးေပးလိုက္ပါ။"));
 //BA.debugLineNum = 46;BA.debugLine="Activity.AddView(lb,2%x,2%y,90%x,35%y)";
...
mostCurrent._b2.setBackground((android.graphics.drawable.Drawable)(mostCurrent._bg.getObject()));
 //BA.debugLineNum = 59;BA.debugLine="Activity.AddView(b1,20%x,(lb.Top+lb.Height),60%x,5";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._b1.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),(int) ((mostCurrent._lb.getTop()+mostCurrent._lb.getHeight())),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (60),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)));
 //BA.debugLineNum = 60;BA.debugLine="Activity.AddView(b2,20%x,(b1.Top+b1.Height)+2%y,60";
...
public static String  _ad1_tick() throws Exception{
 //BA.debugLineNum = 87;BA.debugLine="Sub ad1_Tick";
 //BA.debugLineNum = 88;BA.debugLine="If Interstitial.Ready Then Interstitial.Show Else";
if (mostCurrent._interstitial.getReady()) { 
mostCurrent._interstitial.Show();}
else {
mostCurrent._interstitial.LoadAd();};
 //BA.debugLineNum = 89;BA.debugLine="ad1.Enabled = False";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 90;BA.debugLine="End Sub";
return "";
}
public static String  _ad2_tick() throws Exception{
 //BA.debugLineNum = 92;BA.debugLine="Sub ad2_Tick";
 //BA.debugLineNum = 93;BA.debugLine="If Interstitial.Ready Then Interstitial.Show Else";
if (mostCurrent._interstitial.getReady()) { 
mostCurrent._interstitial.Show();}
else {
mostCurrent._interstitial.LoadAd();};
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 ...
 //BA.debugLineNum = 64;BA.debugLine="If ph.SdkVersion > 19 Then";
if (mostCurrent._ph.getSdkVersion()>19) { 
 //BA.debugLineNum = 65;BA.debugLine="ad1.Enabled = True";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 67;BA.debugLine="Msgbox(\"1. Install Font App\" & CRLF & \"2. After C";
anywheresoftware.b4a.keywords.Common.Msgbox("1. Install Font App"+anywheresoftware.b4a.keywords.Common.CRLF+"2. After Click Change Font and Choose your Font!","Attention!",mostCurrent.activityBA);
 //BA.debugLineNum = 68;BA.debugLine="File.Copy(File.DirAssets,\"MyFont.zip\",File.DirRoo";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"MyFont.zip",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"MyFont.zip");
 //BA.debugLineNum = 69;BA.debugLine="zip.ABUnzip(sd & \"MyFont.zip\",sd & \"MyFont\")";
mostCurrent._zip.ABUnzip(mostCurrent._sd+"MyFont.zip",mostCurrent._sd+"MyFont");
 //BA.debugLineNum = 70;BA.debugLine="File.Delete(File.DirRootExternal,\"MyFont.zip\")";
...
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 72;BA.debugLine="i.Initialize(i.ACTION_VIEW,\"file:///\"&File.Dir";
_i.Initialize(_i.ACTION_VIEW,"file:///"+anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/MyFont/MyFont.apk");
 //BA.debugLineNum = 73;BA.debugLine="i.SetType(\"application/vnd.android.package-archiv";
...
anywheresoftware.b4a.objects.IntentWrapper _abc = null;
 //BA.debugLineNum = 77;BA.debugLine="Sub b2_Click";
 //BA.debugLineNum = 78;BA.debugLine="If ph.SdkVersion > 19 Then";
if (mostCurrent._ph.getSdkVersion()>19) { 
 //BA.debugLineNum = 79;BA.debugLine="ad1.Enabled = True";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 81;BA.debugLine="ToastMessageShow(\"1. Click Font Style Or Font >";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("1. Click Font Style Or Font > "+anywheresoftware.b4a.keywords.Common.CRLF+"2. Choose Myanmar Love Font(iFont)",anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 82;BA.debugLine="Dim abc As Intent";
_abc = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 83;BA.debugLine="abc.Initialize(\"android.settings.DISPLAY_SETTINGS";
_abc.Initialize("android.settings.DISPLAY_SETTINGS","");
 //BA.debugLineNum = 84;BA.debugLine="StartActivity(abc)";
