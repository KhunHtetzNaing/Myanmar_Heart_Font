...
Sub Activity_Create(FirstTime As Boolean)
	...
	lb.Initialize("lb")
	lb.Text = "1. ပထမဦးစြာ Install ကိုနွိပ္ျပီး " &CRLF& "Myanmar Love(ifont) ကို Install လုပ္လိုက္ပါ။" &CRLF&CRLF& "2. Install လုပ္ျပီးပါက Done ကိုနွိပ္ပါ။" &CRLF& "ၿပီးလၽွင္ေအာက္က Change Font ကိုနွိပ္ပါ။" &CRLF& "Font သို့ Font Style ထဲကိုဆက္ဝင္ျပီး" &CRLF& "Myanmar Love Font(ifont) ကိုေရြးေပးလိုက္ပါ။" &CRLF&CRLF& "Android 5.0 အထက္တခ်ို့ဖုန္းေတြမွာ Font not supported လို့ျပလာခဲ့လၽွင္ Tutorial ကိုနွိပ္ျပီးေျဖရွင္းနည္းကိုသြားျကည့္လိုက္ပါ။"
	Activity.AddView(lb,2%x,2%y,90%x,45%y)
...
Sub b3_Click
	...
	StartActivity(i.OpenBrowser("http://www.htetznaing.com/fix-font-Not-supported-error/"))
End Sub
